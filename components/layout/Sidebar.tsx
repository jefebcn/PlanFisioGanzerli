  ...
  return (
    <>
      ...
      <aside className={clsx(
        'w-[240px] min-w-[240px] flex flex-col h-full overflow-y-auto bg-[#13111e] border-r border-slate-800/60 scrollbar-hide',
        ...
        <button
          onClick={onMobileClose}
          className="absolute top-4 right-4 md:hidden w-8 h-8 rounded-full bg-slate-700/80 hover:bg-slate-700 flex items-center justify-center text-slate-400 hover:text-white transition-colors z-10"
        ...
        {/* User quick-switch */}
        <div className="px-4 py-4 border-t border-slate-800/60" style={{ paddingBottom: 'max(1rem, env(safe-area-inset-bottom))' }}>
