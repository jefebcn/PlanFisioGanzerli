...
// Gradient stops across 7 days (purple → teal)
const HEADER_BG = [
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden relative">
      ...
      <div className="flex border-b border-slate-200 bg-white z-10">
        {/* GMT label */}
        <div className="w-16 flex-shrink-0 flex items-end pb-2 justify-center">
        ...
        {days.map((day, i) => {
          ...
          return (
            <div
              ...
              style={{ backgroundColor: isToday ? '#d1fae5' : bg }}
            >
              ...
              <div
                className={clsx(
                  'inline-flex items-center justify-center rounded-full text-sm font-bold w-8 h-8 mx-auto',
              ...
              >
                ...
                {appts.map((a) => {
                  ...
                  return (
                    ...
                    >
                      <div className="text-[11px] font-semibold leading-tight truncate" style={{ color: a.therapist.color }}>
                        {a.patient.fullName}
                      </div>
                      {height > 36 && (
